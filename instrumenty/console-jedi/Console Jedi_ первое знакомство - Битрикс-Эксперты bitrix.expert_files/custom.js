...
Modernizr.load({
	...
	yep :['/local/templates/full/css/touch.css?v=1'],
	nope: ['/local/templates/full/js/waypoints.min.js'],
	complete : function () {
		if (Modernizr.touch){
			//initMobile
...
jQuery.fn.topLink = function(settings) {
	...
	return this.each(function() {
		...
		$(window).scroll(function() {
			...
			{
				el.addClass("top-scroll-show");
				el.removeClass("top-scroll-hide");
			}
			else
			{
				el.addClass("top-scroll-hide");
				el.removeClass("top-scroll-show");
			}
		});
	});
};
